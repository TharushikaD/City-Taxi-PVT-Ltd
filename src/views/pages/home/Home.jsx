            ...
            <div className='show' xl={6} lg={8} md={10} sm={12} xs={12}>
                ...
                {activeSection === 'Mission' && (
                    <div>
                        <h2>Our Mission</h2>
                        <ul>
                            <p>While providing efficient, safe, and affordable taxi services for passengers across island-wide, leveragaing technology to streamline the booking process, enhance passenger and driver communication, and ensure timely services.</p>
                        </ul>
                    </div>
                )}
            </div>
